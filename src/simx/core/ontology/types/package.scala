...
object TimeInSeconds extends SVarDescription[scala.Float, scala.Float](simx.core.ontology.types.Real as Symbols.timeInSeconds definedAt "http://www.hci.uni-wuerzburg.de/ontologies/simx/concepts/BasicTypes.owl#TimeInSeconds")
